 ...
 <nav class="py-2 bg-body-tertiary border-bottom">
    <div class="container d-flex flex-wrap">
      <ul class="nav me-auto">
        ...
        <li class="nav-item"><a href="/book/list_pro.jsp" class="nav-link link-body-emphasis px-2">도서 목록</a></li>
        <li class="nav-item"><a href="/book/create.jsp" class="nav-link link-body-emphasis px-2">도서 입력</a></li>
